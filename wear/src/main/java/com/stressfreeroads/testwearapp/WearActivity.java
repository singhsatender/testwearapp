...
public class WearActivity extends Activity implements HeartbeatService.OnChangeListener, PPGService.OnChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stub.setOnLayoutInflatedListener(new WatchViewStub.OnLayoutInflatedListener() {
            ...
            public void onLayoutInflated(WatchViewStub stub) {
                ...
                // as soon as layout is there...
                mTextView = (TextView) stub.findViewById(R.id.ppg);
                // bind to our service.
                bindService(new Intent(WearActivity.this, PPGService.class), new ServiceConnection() {
                    @Override
                    public void onServiceConnected(ComponentName componentName, IBinder binder) {
                        Log.d(LOG_TAG, "connected to service.");
                        // set our change listener to get change events
                        ((PPGService.PPGServiceBinder)binder).setChangeListener(WearActivity.this);
                    }
